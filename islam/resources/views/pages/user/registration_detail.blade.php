        ...
        <div class="container mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Skype ID:</strong> {{ $user->skype }}</p>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <p><strong>Courses:</strong> {{ $user->courses }}</p>
                </div>
            </div>
            <div class="card mt-3">
                <div class="card-header">
                ...
                <div class="card-body">
                    <p><strong>Classes Per Week:</strong> {{ $user->classes_per_week }}</p>
                    <p><strong>Best Contact Time:</strong> {{ $user->contact_time }}</p>
                    <p><strong>Preferred Teacher Gender:</strong> {{ $user->teacher_gender }}</p>
                </div>
            </div>
        </div>
    </section>
