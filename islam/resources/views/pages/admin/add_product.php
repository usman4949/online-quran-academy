...
<?php
echo form_open(base_url('admin/upload_products'), [
    'class' => '',
    'id' => 'regForm',
...
<div class="card panel_card p-3 mb-3">
    <div class="d-flex align-items-center mb-4">
        ...
        <h6 class="my-auto ms-4">Add Product</h6>
    </div>
    ...
    <div class="row" scroll-target="basic_info">
        <div class="col-md-6 mb-2">
            ...
            <input type="text" class="form-control passenger_form_input" required id='product_name' placeholder="Evening Desert Safari" name="title" value="<?= old('title') ?>">
        ...
        <div class="col-md-6 mb-2">
            ...
            <select class="js-example-basic-multiple form-control p-1 passenger_form_input select_categories w-100" required name="product_category[]" multiple="multiple">

                <?php
                if (!empty($all_productcategory)) {
                    foreach ($all_productcategory as $val) {
                        if (in_array($val['id'], old('product_category', []))) {
                            $selected = 'selected';
                        } else {
                            $selected = '';
                        }
        ...
        <div class="col-md-6 mb-2">
            ...
            <input type="text" class="form-control passenger_form_input" required id='product_slug' placeholder="Evening_Desert_Safari" name="slug" value="<?= old('slug') ?>">

        </div>
        <div class="col-md-12 mb-2">
            <label class="form-label passenger_form_label color_primary mb-1">Overview<span class="required_show">*</span></label>
            <textarea class="form-control passenger_form_input h-auto div_editor1" required rows="4" name="overview"><?= old('overview') ?></textarea>
            <?php
            /********Start Show Name Validation Error*********/
        ...
        <div class="col-md-6 mb-2">
            ...
            <textarea class="form-control passenger_form_input h-auto div_editor11" rows="4" name="meta_description"><?= old('meta_description') ?></textarea>
        </div>

        <div class="col-md-6 mb-2">
            <label class="form-label passenger_form_label color_primary mb-1">Meta Keywords</label>
            <textarea class="form-control passenger_form_input h-auto div_editor12" rows="4" name="meta_keywords"><?= old('meta_keywords') ?></textarea>
        </div>
...
<div class="card panel_card p-3 mb-3" scroll-target="images">
        ...
        <div class="col-md-12 mb-4">
            ...
            <div action="/upload" id="product-gallery" class="dropzone dropzone_main needsclick dz-clickable">
                <div class="dz-message needsclick">
                    <span class="text">
                        <img src="<?= base_url('assets/images/svg/panel_svg/upload_icon.svg') ?>" alt="">
                        <span class="text_light text_medium">Drag and drop Cover image, or <span class="text_orange">Browse</span></span>
                    </span>
                </div>
            </div>
            <input type="hidden" id="product-image" value="" name="productcover_img" required>
    ...
    <div class="row">
        ...
        <p class="mt-2 mb-0 text_small text_light">
            Note: Upload atleast one image of dimension 500x500
        </p>
...
<div class="card panel_card p-3 mb-3" scroll-target="product_feature">
    ...
    <div id="product_table1">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="my-auto">Product Feature</h6>
        </div>
                ...
                <select class="js-example-basic-multiple form-control p-1 passenger_form_input product_feature" name='select_feature' id='product_feature' required multiple="multiple">
                    ...
                    if (!empty($all_productfeature)) {
                        foreach ($all_productfeature as $val) {
                            if (in_array($val['id'], old('product_feature', []))) {
                                $selected = 'selected';
                            } else {
                                $selected = '';
                            }
        ...
        <div class="feature_table">
            <!-- <h6 class="mb-2 my_featuretable" id='product_title'></h6> -->
                    ...
                    <tbody class='featuretable_tr'>
                        ...
                        <!-- <tr>
                                    ...
                                    <td class="p-3 option_namez">
                                        <input type="text" class="form-control" name="feature_value[]" value='<?= old('feature_value[]') ?>' placeholder="Tour Services">
                                    </td>
...
<div class="card panel_card p-3 mb-3" scroll-target="option_table">
    ...
    <div id="product_table">
        <div class="d-flex justify-content-between align-items-center mb-3 myheading">
            <h6 class="my-auto">Option Table</h6>
        ...
        <div class="newtable1">
            <div class="row">
                <div class="col-md-6 mb-4">
                    <label class="form-label passenger_form_label color_primary mb-1">Title </label><span class="required_show">*</span>
                    <input type="text" class="form-control passenger_form_input newtitle" required name='newtitle[]' placeholder="Evening Desert Safari">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 mb-4">
                    <label class="form-label passenger_form_label color_primary mb-1">Description</label>
                    <textarea class="form-control passenger_form_input newdescription div_editor111" name='newdescription[]' placeholder="In this Trip we have ...."></textarea>
                </div>
            </div>
            <div class="price_table">

                <!-- <h6 class="mb-2 my_optiontable" id='product_title'></h6> -->
                <h6 class="mb-2 my_optiontable"></h6>
                <div class="table-responsive mt-2">
                    <table class="table price_offers_table newprice_offers_table table-striped mb-0">
                        <thead>
                            <tr class="bg_light_orange">
                                <input type='hidden' name='product_item[]' class='product_item' value='1'>
                                <!-- <th scope="col" class="p-3" style="min-width: 20px;"></th> -->
                            ...
                            <tr>
                                ...
                                <th scope="row" class="p-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <select class="form-control transfer_typeoption select_option tour_detail_input" name="transfer_type[1][]" style="min-width: 150px;">
                                ...
                                <td class="p-3 option_namez" style="display: none;">
                                    <input type="hidden" class="form-control tour_detail_input option_name mynewoption_name asdasd" id="option_name" name="option_name[1][]">
                                    <textarea class="form-control mytourdescription tour_detail_input mydatadesc mynewoptiondesc" rows="1" name="option_description[1][]"></textarea>
                                </td>
                                <td class="p-3 option_namez">
                                    <input type="number" class="form-control tour_detail_input option_quantity asdasd" id="option_quantity" min="1" name="option_quantity[1][]" placeholder="1">
                                </td>
                                <!-- <td class="p-3"> -->
                                <!-- </td> -->
                                <td class="p-3">
                                    <input <?= $required ?> type="number" class="form-control tour_detail_input allprices adultregular_price" name="adult_regular_price[1][]" min="1" value="<?= old('adult_regular_price[]') ?>" placeholder="110">
                                </td>
                                <td class="p-3">
                                    <input <?= $required ?> type="number" class="form-control tour_detail_input allprices adultsale_price" name="adult_sale_price[1][]" min="1" value="<?= old('adult_sale_price[]') ?>" placeholder="100">
                                </td>
                                <td class="p-3">
                                    <input <?= $required ?> type="number" class="form-control tour_detail_input allprices childregular_price" name="child_regular_price[1][]" min="1" value="<?= old('child_regular_price[]') ?>" placeholder="90">
                                </td>
                                <td class="p-3">
                                    <input <?= $required ?> type="number" class="form-control tour_detail_input allprices childsale_price" name="child_sale_price[1][]" min="1" value="<?= old('child_sale_price[]') ?>" placeholder="80">
                                </td>
                                <td class="p-3">
                                    <input <?= $required ?> type="number" class="form-control tour_detail_input allprices infantregular_price" name="infant_regular_price[1][]" min="1" value="<?= old('infant_regular_price[]') ?>" placeholder="200">
                                </td>
                                <td class="p-3">
                                    <input <?= $required ?> type="number" class="form-control tour_detail_input allprices infantsale_price" name="infant_sale_price[1][]" min="1" value="<?= old('infant_sale_price[]') ?>" placeholder="150">
                                </td>

                                <!-- <td class="p-3">
                                    <div class="justify-content-center">
                                        <button type="button" class="btn btn_action text_orange fs-4 addoption_btn">
                                            +
                                        </button>
        ...
        <table class="table price_offers_table table-striped mb-0">
            ...
            <tbody id='mytable_options'>
                <tr>
                    ...
                    <td class="p-3">
                        <textarea class="form-control tour_detail_input mytourdescription1 mytour newtours" rows="1"></textarea>
...
<div class="card panel_card p-3 mb-3" scroll-target="others">
    ...
    <div id="product_table1">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="my-auto">Product Addons</h6>
        </div>

        <div class="col-sm-12 newaddons">
            <div class="col-md-6 mt-4 newaddons_div">
                ...
                <div class="selectdropdown_addons">
                    ...
                    <p class="mt-2 mb-0 text_small text_light">
                        Note: Select category to get addons
                    </p>
                </div>
...
<div class="card panel_card p-3 mb-3" scroll-target="others">
    ...
    <div id="product_table1">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="my-auto">Product Sections</h6>
        </div>
...
<div class="card panel_card p-3 mb-3 product_sectionhide highlight_section">
    <div class="row">
        <div class="col-md-12 mb-2">
            <label class="form-label passenger_form_label color_primary mb-1">Highlights</label>
            <textarea class="form-control passenger_form_input h-auto div_editor2" name="highlights" rows="4"><?= old('highlights') ?></textarea>
        </div>
    </div>
</div>

<div class="card panel_card p-3 mb-3 product_sectionhide inclusions_section">
    <div class="row">
        <div class="col-md-12 mb-2">
            <label class="form-label passenger_form_label color_primary mb-1">Inclusions</label>
            <textarea class="form-control passenger_form_input h-auto div_editor3" name="inclusion" rows="4"><?= old('inclusion') ?></textarea>
        </div>
    </div>
</div>

<div class="card panel_card p-3 mb-3 product_sectionhide exclusions_section">
    <div class="row">
        <div class="col-md-12 mb-2">
            <label class="form-label passenger_form_label color_primary mb-1">Exclusions</label>
            <textarea class="form-control passenger_form_input h-auto div_editor4" name="exclusion" rows="4"><?= old('exclusion') ?></textarea>
        </div>
    </div>
</div>

<div class="card panel_card p-3 mb-3 product_sectionhide information_section">
    <div class="row">
        <div class="col-md-12 mb-2">
            <label class="form-label passenger_form_label color_primary mb-1">Information</label>
            <textarea class="form-control passenger_form_input h-auto div_editor5" name="information" rows="4"><?= old('information') ?></textarea>
        </div>
    </div>
</div>


<div class="card panel_card p-3 mb-3 product_sectionhide redeem_section">
    <div class="row">
        <div class="col-md-12 mb-2">
            <label class="form-label passenger_form_label color_primary mb-1">Redeem</label>
            <textarea class="form-control passenger_form_input h-auto div_editor6" name="redeem" rows="4"><?= old('redeem') ?></textarea>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.addoption_btn', function() {
            ...
            // $('.option_name').val(productoptionname);
            //var transfer_typeoption =$(this).closest('tr').find('.transfer_typeoption').val();
            // alert(transfer_typeoption);
            //var transfer_typeoption =$('.transfer_typeoption').val();
            var $this = $(this);
            var $table = $this.closest('table');
            var selectedValues = [];
            //var transfer_typeoption =$(this).closest('tr').find('.transfer_typeoption');
            ...
            $.ajax({
                ...
                success: function(html) {
                    //$('.option_tablebody').append(html);
                    $this.closest('.option_tablebody').append(html);
                }
            });

            // var productoptionname = $('.newtitle').val();
            // $('#product_title').html(productoptionname);
            // $('.tour_optionname').val(productoptionname);
            // $('.mynewoption_name').val(productoptionname);

            // var productoptiondesc = $('.newdescription').val();
            // $('.mytour').val(productoptiondesc);
            // $('.mynewoptiondesc').html(productoptiondesc);
        });
