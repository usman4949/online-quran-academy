...
<div class="card panel_card p-2">
    ...
    <ul class="nav flex-column nav-pills nav-fill sidebar_height">
        <li class="nav-item mb-2" role="presentation" style="flex: none;">
            <a class="nav-link sidebar_nav_text <?= (in_array('dashboard', $uriSegments)) ? 'active' : '' ?>" href="<?= base_url('/user/dashboard') ?>">
                <img src="<?= base_url('/') ?>/assets/images/svg/panel_svg/dashboard<?= (in_array('dashboard', $uriSegments)) ? '_active' : '' ?>.svg" class="me-2" alt="">
                Dashboard
            </a>
        </li>
        <li class="nav-item mb-2" role="presentation" style="flex: none;">
            <a class="nav-link sidebar_nav_text <?= (in_array('profile', $uriSegments)) || (in_array('add_profile', $uriSegments)) ? 'active' : '' ?>" href="<?= base_url('/user/profile') ?>">
        ...
        <!-- <li class="nav-item mb-2" role="presentation" style="flex: none;">
            ...
            <img src="<?= base_url('/') ?>/assets/images/svg/panel_svg/profile<?= (in_array('products', $uriSegments)) || (in_array('add_products', $uriSegments)) ? '_active' : '' ?>.svg" class="me-2" alt="">
              Products
            </a>
        </li> -->
      
        <li class="nav-item mb-2" role="presentation" style="flex: none;">
            <a class="nav-link sidebar_nav_text <?= (in_array('booking', $uriSegments)) ? 'active' : '' ?>" href="<?= base_url('/user/booking') ?>">
        ...
        <li class="nav-item mb-2" role="presentation" style="flex: none;">
            <a class="nav-link sidebar_nav_text" href="<?=base_url('user/wishlist')?>">
                <img src="<?= base_url('assets/images/svg/panel_svg/favourite.svg') ?>" class="me-2" alt="">
                WishList
            </a>
        </li>
